...
#As this is a group project, as an extended feature we made this administrator class which controls the items displayed in main menu, it can add/remove items and adjusts their quantity
    lst=[]
    def setList(self):
        '''append names of entered item into a 2D list along with their quantities'''
    ...
    def getList(self):
        '''Return list containig items'''
        return Administrator.lst
    def RemoveItems(self):
        
        '''Removes items from the list entered by user'''
    ...
    def AddItems(self):
        ...
        '''Adds more item to the main menu'''
    ...
    def SaveToFile(self,fil):          ##Storing list of items into a file
        '''Saves displayed items into a file'''
...
class PrintMenu (Administrator) :       ##Inheritance
    ...
    def Display(self):
        '''Prints list of displayed items'''
...
class ShoppingItems(Administrator):             ##Inheritance
    ...
    def AddToCart(self):
        '''Add items to cart and remove entered quantity from main stock'''
...
class MainMenu:
    ...
    def Customer_Records(self):
        p=input("Do You Want to See the Account Details and Shopping History for all Customers?").lower()
        if p =='y':
            self.d=ViewHistory()                ##Composition
            self.d.printHistory()
        else:
            print("It was a great pleasure having you with us, goodbye!")
